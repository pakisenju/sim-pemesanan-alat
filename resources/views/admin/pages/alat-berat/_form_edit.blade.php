<div class="mb-3">
    <label for="editNamaAlat" class="form-label">
        Nama Alat
...
<div class="mb-3">
    <label for="editThumbnail" class="form-label">
        Thumbnail
        <span class="text-danger">*</span>
    </label>
...
<div class="mb-3">
    <label for="editStatusKetersediaan" class="form-label">
        Status Ketersediaan
        <span class="text-danger">*</span>
    </label>
...
<div class="mb-3">
    <label for="editTahunPembuatan" class="form-label">
        Tahun Pembuatan
        <span class="text-danger">*</span>
    </label>
