<div class="mb-3">
    <label for="addNamaAlat" class="form-label">
        Nama Alat
...
<div class="mb-3">
    <label for="addThumbnail" class="form-label">
        Thumbnail
        <span class="text-danger">*</span>
    </label>
...
<div class="mb-3">
    <label for="addKapasitas" class="form-label">
        Kapasitas
        <span class="text-danger">*</span>
    </label>
...
<div class="mb-3">
    <label for="addHargaSewa" class="form-label">
        Harga Sewa (Per jam)
        <span class="text-danger">*</span>
    </label>
...
<div class="mb-3">
    <label for="addStatusKetersediaan" class="form-label">
        Status Ketersediaan
        <span class="text-danger">*</span>
    </label>
...
<div class="mb-3">
    <label for="addTahunPembuatan" class="form-label">
        Tahun Pembuatan
        <span class="text-danger">*</span>
    </label>
...
<div class="mb-3">
    <label for="addLokasi" class="form-label">
        Lokasi
        <span class="text-danger">*</span>
    </label>
...
<div class="mb-3">
    <label for="addDeskripsi" class="form-label">
        Deskripsi
        <span class="text-danger">*</span>
    </label>
